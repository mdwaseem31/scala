object scala6ArrayListFillTabulateRange {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(55); val res$0 = 
	...
	inputList(5);System.out.println("""res13: List[Int] = """ + $show(res$13));$skip(220); val res$14 = 

object scala11PatternsAndCaseClasses {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(254); 

//**************************************************	CASE CLASS	**************************************************
	//Till now we were using tuples to group data as shown below:
	val person = ("Waseem Mohammed",25);System.out.println("""person  : (String, Int) = """ + $show(person ));$skip(11); val res$0 = 
	...
	case class Person(name:String,age:Int);System.out.println("""name  : String = """ + $show(name ));System.out.println("""age  : Int = """ + $show(age ));$skip(510); 
	//Below is the syntax for instantiating an instance of case class Person2
	val waseem = Person("Waseem Mohammed",25);System.out.println("""waseem  : scala11PatternsAndCaseClasses.Person = """ + $show(waseem ));$skip(154); val res$2 = 
	...
	waseem.name;System.out.println("""res2: String = """ + $show(res$2));$skip(12); val res$3 = 
	waseem.age

	case class Vect(x:Double,y:Double,z:Double);System.out.println("""res3: Int = """ + $show(res$3));$skip(67); 
	val v = Vect(1,2,3);System.out.println("""v  : scala11PatternsAndCaseClasses.Vect = """ + $show(v ));$skip(5); val res$4 = 
	v.x;System.out.println("""res4: Double = """ + $show(res$4));$skip(69); 
	
	def magnitude(v:Vect):Double = math.sqrt(v.x*v.x+v.y*v.y+v.z*v.z);System.out.println("""magnitude: (v: scala11PatternsAndCaseClasses.Vect)Double""");$skip(14); val res$5 = 

object scala10PatternsAndCaseClasses {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(243); 
...
//**************************************************	CASE CLASS	**************************************************
	...
	val mark = Person("Mark",38);System.out.println("""mark  : scala10PatternsAndCaseClasses.Person = """ + $show(mark ));$skip(152); val res$2 = 
	...
	val v = Vect(1,2,3);System.out.println("""v  : scala10PatternsAndCaseClasses.Vect = """ + $show(v ));$skip(5); val res$4 = 
	v.x;System.out.println("""res4: Double = """ + $show(res$4));$skip(69); 
	
	def magnitude(v:Vect):Double = math.sqrt(v.x*v.x+v.y*v.y+v.z*v.z);System.out.println("""magnitude: (v: scala10PatternsAndCaseClasses.Vect)Double""");$skip(14); val res$5 = 

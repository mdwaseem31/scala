...
//**************************************************	CASE CLASS	**************************************************
	...
	val person = ("Mark",38)                  //> person  : (String, Int) = (Mark,38)
	person._1                                 //> res0: String = Mark
	person._2                                 //> res1: Int = 38
	
	//Another way is to
	val (name,age) = person                   //> name  : String = Mark
                                                  //| age  : Int = 38
	...
	val mark = Person("Mark",38)              //> mark  : scala11PatternsAndCaseClasses.Person = Person(Mark,38)
	...
	mark.name                                 //> res2: String = Mark
	mark.age                                  //> res3: Int = 38
